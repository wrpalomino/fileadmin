...
class ahNewRelationsContainerForm extends BaseForm
{
  public function configure()
  {
    ...
    $custom_decorator = new EmbeddedFormContainerSchemaFormatter($this->getWidgetSchema());
    $this->widgetSchema->addFormFormatter('MyCFormatter', $custom_decorator);
    $this->widgetSchema->setFormFormatterName('MyCFormatter');
  }
