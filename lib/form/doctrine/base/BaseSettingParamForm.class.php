...
/**
 * SettingParam form base class.
 *
 * @method SettingParam getObject() Returns the current form's model object
 *
 * @package    PhpProject1
 * @subpackage form
 ...
 */
abstract class BaseSettingParamForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('setting_param[%s]');
