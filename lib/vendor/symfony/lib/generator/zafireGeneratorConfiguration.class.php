 ...
 * @version    SVN: $Id: zafireGeneratorConfiguration.class.php 29656 2010-05-28 13:09:33Z Kris.Wallsmith $
 */
abstract class zafireGeneratorConfiguration
{
  protected
    $configuration = array();
  ...
  // added by William, 03/02/2012
  abstract public function getAjaxeditActions();
  
  abstract public function getAjaxeditTitle();
  
  abstract public function getFieldsAjaxedit();

  abstract public function getAjaxeditDisplay();
  ...
  protected function compile()
  {
    ...
    $this->configuration = array(
      ...
      'new'    => array(
        ...
        'return_to' => $this->getNewReturnTo(), // added by William, 03/02/2012
      ),
      'edit'   => array(
        'fields'  => array(),
        'title'   => $this->getEditTitle(),
        'actions' => $this->getEditActions() ? $this->getEditActions() : $this->getFormActions(),
        'return_to' => $this->getEditReturnTo(), // added by William, 03/02/2012
      ),
      // added by William, 03/02/2012
      'ajaxedit' => array(
        'fields' => array(),
    ...
    foreach (array_keys($config['default']) as $field)
    {
      ...
      // added by William, 03/02/2012
      $this->configuration['ajaxedit']['fields'][$field]   = new sfModelGeneratorConfigurationField($field, array_merge($formConfig, isset($config['ajaxedit'][$field]) ? $config['ajaxedit'][$field] : array()));
    ...
    // form actions
    foreach (array('edit', 'new', 'ajaxedit', 'show') as $context)
    {
    ...
    // added by William, 03/02/2012
    $this->parseVariables('ajaxedit', 'title');
  ...
  public function getValue($key, $default = null, $escaped = false)
  {
    ...
    {
      $v = zafireGeneratorConfiguration::getFieldConfigValue($this->getContextConfiguration($matches['context']), $matches['key'], $default);
    }
    else
    {
  ...
  protected function getConfig()
  {
    return array(
      ...
      // added by William, 03/02/2012
      'ajaxedit' => $this->getFieldsAjaxedit(),
