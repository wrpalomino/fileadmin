...
<?php unset($this->config['show']['actions']) ?>
  ...
  public function getAjaxeditActions()
  {
    return <?php echo $this->asPhp(isset($this->config['ajaxedit']['actions']) ? $this->config['ajaxedit']['actions'] : array()) ?>;
<?php unset($this->config['ajaxedit']['actions']) ?>
  }
  
  public function getForm2Actions()
  {
    return <?php echo $this->asPhp(isset($this->config['form2']['actions']) ? $this->config['form2']['actions'] : array()) ?>;
<?php unset($this->config['form2']['actions']) ?>
  }