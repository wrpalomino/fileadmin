 ...
 */
abstract class Base<?php echo ucfirst($this->getModuleName()) ?>GeneratorConfiguration extends zafireGeneratorConfiguration
{
...
<?php include dirname(__FILE__).'/sortingConfiguration.php' ?>
  ...
  {
    if (null !== $this->tableMethod) return $this->tableMethod;
