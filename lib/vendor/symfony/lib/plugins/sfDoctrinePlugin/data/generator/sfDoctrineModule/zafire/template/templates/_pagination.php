[?php $default_action = $helper->getActionUrl(); ?]

[?php 
  $request = sfContext::getInstance()->getRequest();
  $filter = ($request->getParameter('filter')) ? '&filter='.$request->getParameter('filter') : '';
?]

<div class="sf_admin_pagination">
  <a href="[?php echo url_for($default_action) ?]?page=1[?php echo $filter?]">
  ...
  <a href="[?php echo url_for($default_action) ?]?page=[?php echo $pager->getPreviousPage() ?][?php echo $filter?]">
  ...
  [?php foreach ($pager->getLinks() as $page): ?]
    [?php if ($page == $pager->getPage()): ?]
      [?php echo $page ?]
    [?php else: ?]
      <a href="[?php echo url_for($default_action) ?]?page=[?php echo $page ?][?php echo $filter?]">[?php echo $page ?]</a>
    [?php endif; ?]
  [?php endforeach; ?]
  
  [?php endif; ?]

  <a href="[?php echo url_for($default_action) ?]?page=[?php echo $pager->getNextPage() ?][?php echo $filter?]">
  ...
  <a href="[?php echo url_for($default_action) ?]?page=[?php echo $pager->getLastPage() ?][?php echo $filter?]">
