 ...
 * @property Doctrine_Collection $Subgroup
 * 
 ...
 * @method Doctrine_Collection getSubgroup()               Returns the current record's "Subgroup" collection
 * @method sfGuardGroup        setCode()                   Sets the current record's "code" value
 ...
 * @method sfGuardGroup        setAgency()                 Sets the current record's "Agency" collection
 * @method sfGuardGroup        setCorrespondence()         Sets the current record's "Correspondence" collection
 * @method sfGuardGroup        setSubgroup()               Sets the current record's "Subgroup" collection
 * 
 * @package    PhpProject1
 * @subpackage model
...
abstract class BasesfGuardGroup extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Correspondence', array(
             'local' => 'id',
             'foreign' => 'receiver_group_id'));

        $this->hasMany('Subgroup', array(
             'local' => 'id',
             'foreign' => 'group_id'));
