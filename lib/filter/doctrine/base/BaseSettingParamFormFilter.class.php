...
/**
 * SettingParam filter form base class.
 *
 * @package    PhpProject1
 * @subpackage filter
 ...
 */
abstract class BaseSettingParamFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('setting_param_filters[%s]');
