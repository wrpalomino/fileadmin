...
/**
 * comment by William, 04/04/2013: this class is required to be used with a custom pdf-converter engine installed
 * in the server, it will stop using third party paid service to covert html into pdf
 * 
 * 
