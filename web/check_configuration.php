...
//  added by William, 02-02-2012: to test database
$MySQLHost = 'localhost';
$MySQLDataBase = 'dbcrimla_fileadmin';
echo '<br/><br/><br/>Connecting to database server ' . $MySQLHost . '.....';

$link = mysql_connect($MySQLHost, 'dbcrimla_admin', 'fileadmin1234');
if (!$link) {
...
echo "<br/>company name: ". $row[1];
echo "<br/>company address: ". $row[2];
