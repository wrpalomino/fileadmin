...
var SelectDependiente = function(config)
{
    ...
    // added by William, 17/02/2012: to fix bug of an empty dependend list
    this.selectedInd = (this.dependiente) ? null : document.getElementById(this.id).selectedIndex;
...
SelectDependiente.prototype.mostrar = function(grupo, forzar)
{
    ...
    // added by William, 17/02/2012: to fix bug of an empty dependend list
    if (this.selectedInd !== null) document.getElementById(this.id).selectedIndex = this.selectedInd;
