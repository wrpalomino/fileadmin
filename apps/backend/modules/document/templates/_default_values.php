<?php
  //echo mb_convert_encoding(AdminContent::getText($obj->helper->document_tpl_file, $field), "HTML-ENTITIES", "UTF-8");
  echo AdminContent::getText($obj->helper->document_tpl_file, $field);

/*$default_values = array(
    'brirq1' => array(
'document_field17' => 'APPLICATION FOR BRIEF OF EVIDENCE<br/><br/>
...
to the alleged offence. We would be grateful to receive that material immediately.'
    ...
    'trmoin' => array(
'document_field17' => 'To our professional costs of and in connection with attending upon you and taking 
...
appearing on your behalf;'
    ...
    'aplema' => array(
'document_field17' => 'Please ring and make an appointment to see me.<br/><br/><br/>
Thank you for your assistance in relation to this matter.'
    ),
    
    'brfwcp' => array(
'document_field17' => 'Please find enclosed a copy of the Police brief.<br/><br/>
Please ring our office and make an appointment to see me once you have read it.'
    ),
    
    'brrmat' => array(
'document_field17' => 'We have received the copy of the Brief of Evidence in relation to your upcoming matter.<br/>
...
We look forward to hearing from you.'
    ...
    'brwwfc' => array(
'document_field17' => 'We refer to the above and write to advise that we are still awaiting the police brief in your 
...
In the meantime, please do not hesitate to contact this office should you have any questions about your matter.'
    ...
    'clovle' => array(
'document_field17' => 'Please find attached letter from County Court in relation to your matter.<br/>
...
You must attend the Callover.'
    ...
    'canoco' => array(
'document_field17' => 'We refer to the above and advise that we have made several attempts to contact you regarding 
your matter.<br/>
...
We have notified the Court that we are no longer representing you in this matter.'
    ...
    'canofu' => array(
'document_field17' => 'We refer to the above matter and advise that we have ceased to act on your behalf.<br/>
Your legal fees were not paid by the due date and you failed to contact us to make alternative arrangements.<br/>
We have notified the Court that we are no longer representing you in this matter.'
    ),
    
    'cansla' => array(
'document_field17' => 'We refer to the above matter and advise that we have ceased to act on you behalf.<br/>
...
We have notified the Court that we are no longer representing you in this matter.'
    ...
    'docpro' => array(
'document_field17' => 'Please forward as soon as possible the following to our office:<br/><br/><br/>
Thank you for your assistance in this matter'
    ),

    'ftasum' => array(
'document_field17' => 'You were on a summons and your matter was to be heard on the above date.<br/>
...
If you want some assistance in dealing with this problem please contact us as soon as possible.'
  ...
  'ftabai' => array(
'document_field17' => 'As you were on bail you were required to attend Court on the above date.<br/>
Due to the fact that you did not attend Court a warrant has been issued for your arrest.<br/>
...
If you want some assistance in dealing with this problem please contact us as soon as possible.'
    ...
    'lapsfo' => array(
'document_field17' => 'Please find enclosed a legal aid application form. Please complete and sign the form and 
...
If you are working, we will require one recent payslip and the last three months of your bank statements.'),
    ...
    'laffop' => array(
'document_field17' => 'Please find enclosed a legal aid application form which has been completed on your behalf 
...
send it back as soon as possible.'
    ...
    'lapfof' => array(
'document_field17' => 'Please find enclosed a legal aid application form . Please just sign it on the back page 
...
If you are working, we will require one recent payslip and the last three months of your bank statements.'
    ...
    'lanmam' => array(
'document_field17' => 'We refer to the above.<br/><br/>
...
Any queries, please contact this office.'
    ...
    'larefu' => array(
'document_field17' => 'Victoria Legal Aid have advised that your application for legal aid has been refused. The
...
Please contact us immediately to confirm you want us to act in relation to your matter.'
    ...
    'pocafe' => array(
'document_field17' => 'Your matter is next listed on the above date.<br/><br/>
...
Should you have any questions about this please contact me'
    ...
    'relein' => array(
'document_field17' => 'We confirm the result of your appearance at Court.<br/>
...
Please contact us if you want to discuss any of this information'
    ...
    'faxefa' => array(
'document_field17' => 'Please find attached an authority signed by our client.'),
    
    'crfxco' => array(
'document_field17' => 'Please find enclosed a guide to writing a character reference.'),
    
    'foirps' => array(
'document_field17' => 'Please find enclosed a Freedom of Information request form in accordance with the Freedom 
...
Please contact us if you have any questions about this request.'
    ...
    'apnofx' => array(
'document_field17' => 'Please find enclosed Notice of Appeal papers in relation to our client.<br/><br/>
Please contact us if you want to discuss this matter.'
    ),
    
    'comefx' => array(
'document_field17' => 'This matter has been adjourned for a contest mention.<br/><br/>
...
Please contact us to discuss this matter prior to the Court date.'
    ...
    'drdeso' => array(
'document_field17' => "You are the Informant in our client's matter that is listed on the above date.<br/><br/>
...
Thank you for your assistance."
    ...
    'divlet' => array(
'document_field17' => "We respectfully submit that this is a matter suitable for recommendation fo the Diversion
...
Thank you for your consideration. Do not hesitate to contact me should you want to discuss this matter further."
    ...
    'dorefu' => array(
'document_field17' => "We act for the above named.<br/><br/>
Please provide our office with the following documents which were not included in the brief;"
    ),
    
    'ftassi' => array(
'document_field17' => "You are the Informant in our client's matter that was listed on the above date. Our client 
...
Thank you for your assistance."
    ...
    'ftasmi' => array(
'document_field17' => "You are the Informant in our client's matter that was listed on the above date.<br/>
...
Thank you for your assistance."
    ...
    'inoble' => array(
'document_field17' => "We are instructed by the above-named to act on their behalf.<br/><br/>
...
Thank you for your assistance in relation to this matter."
    ...
    'inrere' => array(
'document_field17' => "We act for the abovenamed in a case where you are the Informant. They no longer have their 
...
Thank you for your assistance in relation to this matter."
    ...
    'remuin' => array(
'document_field17' => "You are the Informant in one of our client’s matters that was listed on the above date. Our 
...
Thank you for your assistance."
    ...
    'wiprre' => array(
'document_field17' => "We act for the abovenamed in relation to the upcoming hearing where you are the Informant.<br/><br/>
...
Thank you for your assistance in relation to this matter."
    ...
    's32cas' => array(
'document_field17' => "Pursuant to section to s. 32(c)(1) of the Evidence (Miscellaneous Provisions) Act 1958 
...
Melbourne to seek leave to issue a subpoena for protection of protected documents."
     ...
     's32cma' => array(
'document_field17' => "that the Defendant proposes to seek leave pursuant to s. 32(c)(1) of the Evidence Act 1958 
(Vic) in relation to evidence of confidential communications:"
    ),
    
    's34psm' => array(
'document_field17' => "that the Defendant proposes to seek leave pursuant to s. 342 of the Criminal Procedure Act 
...
or why it is a proper matter for cross-examination as to credit is as follows:"
    ...
    'alinot' => array(
'document_field17' => "*a. [State the name of each witness the accused proposes to call];<br/><br/>
...
arrange for this notice, when completed by the accused, to be given or sent to the prosecutor or infomant."
    ...
    'fxenad' => array(
'document_field17' => "Please find attached the request for an adjournment that we forwarded to the Court."),
    
    'fxendc' => array(
'document_field17' => "Please find attached documents in relation to our client’s matter."),
    
    'sccolt' => array(
'document_field17' => "We seek to have an out of court summary case conference with a Prosecutor about this case.
...
may refer to this letter on the issue of costs."
    ...
    'nstinv' => array(
'document_field17' => "To our professional costs;"
    ),
    
    'paircp' => array(
'document_field17' => "We have received the sum of $%%amount%%.<br/><br/>
...
Thank you for your payment in relation to this matter."
    ...
    'intrcp' => array(
'document_field17' => "We have received the sum of $%%amount%% for our professional costs in relation to your matter 
...
Thank you for your payment in relation to this matter."
    ...
    'fagecl' => array(
'document_field17' => "Thank you for your instructions to act for you in this matter.<br/><br/>
...
Please pay the fees of $ %%total%% by %%date%%"
    ...
    'falsmd' => array(
'document_field17' => "This amount includes your representation at Court and is calculated on the matter resolving 
...
and requiring only one appearance."
    ...
    'appoin' => array(
'document_field17' => 'Please note that as this is funded by VLA and thus the grant is subject to a ‘Whole of Job’ 
...
Please contact us if you want to discuss this matter"
    ...
    'adcome' => array(
'document_field17' => "ADJOURNMENT TO CONTEST MENTION<br/>
...
Please contact our office if there are any difficulties with this request."
    ...
    'adcopl' => array(
'document_field17' => "ADJOURNMENT TO CONSOLIDATION<br/><br/>
...
Solicitor reference number for Court:__________"
    ...
    'adgupl' => array(
'document_field17' => "ADJOURNMENT TO GUILTY PLEA<br/><br/>
...
Solicitor reference number for Court:__________"
    ...
    'adsucc' => array(
'document_field17' => "ADJOURNMENT TO ENABLE SUMMARY CASE CONFERENCE TO BE HELD<br/>
INFORMANT: %%informant%%<br/><br/>
...
Solicitor reference number for Court:__________"
    ...
    'fmsafm' => array(
'document_field17' => "ADJOURNMENT TO FURTHER MENTION<br/>
INFORMANT: %%informant%%<br/><br/>
...
Solicitor reference number for Court:__________"
    ...
    'misafm' => array(
'document_field17' => "ADJOURNMENT TO FURTHER MENTION<br/><br/>
...
Solicitor reference number for Court:__________"
    ...
    'timcer' => array(
'document_field17' => "LISTING FOR TIME CERTAINTY<br/><br/>
...
Solicitor reference number for Court:__________"
    ...
    'mlttfi' => array(
'document_field17' => "<br/><br/><br/>
We apologise for the inconvenience.<br/><br/>
Please contact our office if you have any questions"
    ),
    
    'combar' => array(
'document_field17' => "Please note that in relation to this matter we have briefed.<br/><br/>
The date that the barrister was briefed was"
    ),
    
    'cobafx' => array(
'document_field17' => "Please note that in relation to this matter we have briefed counsel in relation to this matter:<br/><br/>
The date that the barrister was briefed was"
    ),
    
    'comple' => array(
'document_field17' => "Please note that this matter has resolved into a plea of guilty.<br/><br/>
...
Please contact us if you have any questions in relation to this matter."
    ...
    'fm211e' => array(
'document_field17' => "1. Is our firm acting for %%client%%?<br/><br/><br/>
...
6. WE NOTE WE MUST NOTIFY THE CTLD IN WRITING OF THE NAME OF COUNSEL AND WHEN BRIEFED<br/><br/>"
    ...
    'en211e' => array(
'document_field17' => "Please find enclosed Form 2-11E.<br/><br/>
Please contact us if you have any questions in relation to this matter."
    ),
    
    'rcrnnb' => array(
'document_field17' => "We act for the abovenamed.<br/><br/>
...
Their date of birth is %%date_of_birth%%"
    ...
    'reprlo' => array(
'document_field17' => "We act for the abovenamed.<br/><br/>Please advise of their current location.<br/>
Their date of birth is %%date_of_birth%%"
    ),
...
Please contact us if you want to discuss any of this information."
    ...
    'relirs' => array(
'document_field17' => "____________________ appeared before ________ who made the following order:<br/>
...
licence restoration hearing and we will guide you through the process."
    ...
    'ceexre' => array(
'document_field17' => "We appeared for our above-named client on _________________________.<br/>
...
If there are any difficulties with this request please contact our office."
    ...
    'goftye' => array(
'document_field17' => "Please find enclosed a gaol order in relation to our client.<br/><br/>
...
Thank you for your assistance in relation to this matter."
    ...
    'fxff25' => array(
'document_field17' => "Please find attached a Form 2 in relation to this matter which is listed for a filing
hearing.<br/><br/>
...
Please contact us if there is any difficulty with this request."
    ...
    'spmeco' => array(
'document_field17' => "We refer to the above and request a Special Mention to be listed on in accordance 
...
We thank you for your assistance in this matter."
    ...
    'spmenc' => array(
'document_field17' => "We refer to the above and request a Special Mention be listed as soon as possible
...
We thank you for your assistance in relation to this matter."
    ...
    'banoti' => array(
'document_field17' => "that an Application for bail is sought to be made before a Judge in the %%court_name%% at 
%%court_address%%<br/>by the abovementioned Applicant"
    ),
    
    'laapfu' => array(
'document_field17' => "TAKE NOTICE the accused %%client_name%% will make application to the Court on %%court_date%% 
...
Act (2009) Victoria Legal Aid provide assistance to the accused and fund their matter."
    ...
    'apacno' => array(
'document_field17' => "I, %%client_name%% am convicted of the offence of<br/>
...
(State briefly the grounds upon which you wish to appeal against the conviction)"
    ...
    'bafiti' => array(
'document_field18' => "Details of Co-Accused (list the name of ALL co-accused, date/s of any bail application and the 
...
Name/Case# _______________________ Bail App ___/___/_____ Magistrate _________________"
    ...
    'baprre' => array(
'document_field19' => "(List all previous bail applications by date and the name of the magistrate/s before whom the 
...
Date ___/___/_____ Magistrate __________________<br/>"
    ...
    'bavoco' => array(
'document_field17' => "Application is made under section 25 of the Bail Act that the defendant be brought before the 
Court to be further dealt with"
    ),
 
    'coplou' => array(
'document_field17' => "1. FAMILY<br/>
Where BORN?<br/><br/><br/>
...
$default_values['reflma'] = $default_values['reshfi'] = $default_values['relein'];

$default_values['baprre']['document_field18'] = $default_values['bafiti']['document_field18'];

// appeal against coviction & sentence
$default_values['apasno'] = str_replace('conviction', 'sentence', $default_values['apacno']);

// bail app & variation
$default_values['bavano'] = $default_values['banoti'];

// prison: YTC = gaol = Prison
$default_values['ytcloc'] = $default_values['rqsgao'] = $default_values['reprlo'];

// barrister section backsheet
$default_values['aoinai'] = $default_values['apopra'] = $default_values['appopp'] = $default_values['apcdpp'] = $default_values['appoin'];
$default_values['dapopp'] = $default_values['cdppro'] = $default_values['dacdpp'] = $default_values['appoin'];
$default_values['ofoppr'] = $default_values['oinain'] = $default_values['otprag'] = $default_values['polinf'] = $default_values['appoin'];

// informant section forms
$default_values['s32coc'] = $default_values['s32cma'];
$default_values['s34pso'] = $default_values['s34psm'];

// invoices default content
$default_values['trnmin'] = $default_values['stdinv'] = $default_values['trmoin'];

// all the brief have the same default text
$default_values['brirq2'] = $default_values['brirq3'] = $default_values['brirq4'] = $default_values['brirq1'];

// agencies
$default_values['e211fx'] = $default_values['en211e'];

// format the text area content before loading...
if (isset($default_values[$obj->helper->document_tpl_file][$field])) {
  $raw_text = str_replace(array("\n", "\r"), "", $default_values[$obj->helper->document_tpl_file][$field]);
  echo str_replace("<br/>", "\n", $raw_text);
} */
