<?php if ($sf_user->hasFlash('custom_error')): ?>
  <div id="sf_admin_container"><div class="error"><?php echo __($sf_user->getFlash('custom_error'), array(), 'sf_admin') ?></div></div>
<?php endif; ?>

<?php if ($sf_user->hasFlash('custom_info')): ?>
  <div id="sf_admin_container"><div class="info"><?php echo __($sf_user->getFlash('custom_info'), array(), 'sf_admin') ?></div></div>
<?php endif; ?>

<?php if ($sf_user->hasFlash('custom_notice')): ?>
  <div id="sf_admin_container"><div class="notice"><?php echo __($sf_user->getFlash('custom_notice'), array(), 'sf_admin') ?></div></div>
<?php endif; ?>
